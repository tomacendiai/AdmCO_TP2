...
class RPS_MultipleGame:
    ...
    def play_game(self, player_choice):
        computer_choice = self.get_computer_choice(
            player_choice
        )  # Passer le choix du joueur comme argument
    ...
    def get_computer_choice(self, player_choice):
        ...
        player_choice_counts = {
            choice: player_choices.count(choice) for choice in ["R", "P", "S"]
        }
    ...
    def show_history(self):
        ...
        for player_choice, computer_choice, result in self.history:
            print(
                f"Joueur: {player_choice}, Ordinateur: {computer_choice}, Résultat: {result}"
            )
